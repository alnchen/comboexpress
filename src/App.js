        ...
        <Modal visible={this.state.isBottomDialogOpen} effect="fadeInUp" onClickAway={ () => {
          ...
          <div className="mobile-popout">
            ...
            <div className="phone-button-wrapper">
              <a href="tel:707-648-1066" className="mobile-popout-number"><img src="https://res.cloudinary.com/ac31624/image/upload/v1590560559/combo/phone_icon.png"  className="mobile-popout-phone-icon" /><span id='phone-number'>707-648-1066</span></a>
            </div>
          </div>
        </Modal>
        {/* <SlidingPane
